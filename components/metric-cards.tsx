      ...
      <Card className="hover:scale-[1.02] transition-transform duration-200">
        <CardContent className="p-6">
          ...
          <div className="flex items-baseline gap-2 mb-2">
            <div className="text-4xl font-bold text-orange-600 dark:text-orange-400">78</div>
          ...
          <div className="w-full bg-slate-200 dark:bg-slate-800 rounded-full h-2 mb-4">
            <div className="bg-orange-600 dark:bg-orange-400 h-2 rounded-full" style={{ width: '78%' }}></div>
          </div>
          <Button variant="link" className="px-0 text-orange-600 dark:text-orange-400 h-auto mt-2 text-sm font-medium">
